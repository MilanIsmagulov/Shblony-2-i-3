...
let BlackBtn = document.querySelector('#check_button_0');
...
if (numberOfQuestion != 1){
    BlackBtn.classList.remove('disabled_button')
    BlackBtn.setAttribute('onclick', onclick=`location.href='../javascript_quiz_app_${numberOfQuestion-1}/index.html'`)
} else {
    BlackBtn.classList.add('disabled_button')
}
